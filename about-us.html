...
<head>
   ...
   <link rel="stylesheet" href="css/style.css">
    <title>Mohammad Arman Portfolio</title>
</head>
<body>
    <nav class="navbar">
        <ul>
            <li>
                <h1>
                    <a href="index.html"><span class="fas fa-code" aria-hidden="true"></span><span class="brand-name"> Mohammad Arman</span></a>
          </h1>
        </li>
        <li><a href="index.html#projects">Projects</a></li>
            ...
            <li>
                <a href="https://github.com/mdarmandev" target="_blank">
...
>this</a
              >, and multiple links look <a href="#">like this</a> and
                ...
                <div class="gradient"></div>
                <footer>
                    <h2>Mohammad Arman &middot; Educator</h2>
                    <ul>
                        <li>
                            <a href="#linkedin" target="_blank">
                                <span class="fab fa-linkedin" aria-hidden="true"></span>
                    ...
                    <p><small>&copy; 2021 Mohammad Arman. All rights reserved.</small></p>
                </footer>
</body>
</html>
